...
Esta skill orienta a criação e otimização de landing pages com foco em conversão, aplicando princípios de UX, psicologia do consumidor e copywriting.
...
4. **Solução/Benefícios**
   ...
   - Foque em benefícios (transformações), não em características técnicas.
...
Consulte os templates na pasta `templates/` para estruturas de wireframe de landing pages.
