...
Esta skill orienta o processo de pesquisa de experiência do usuário, desde o planejamento até a síntese de insights acionáveis para o design de produtos e serviços.
...
Consulte os templates na pasta `templates/` para modelos de personas, jornadas e roteiros de entrevista.
